const totalExps = [
	...
	15020, 15823, 16644, 17483, 18340, 19215, 20108, 20108, 21018, 21946, 22891, 23854, 24834, 25831,
	26846, 27878, 28927, 29993, 31355, 32917, 34664, 36610, 38805
];
...
const dreamShardsPerCandy = [
	...
	236, 250, 264, 279, 295, 309, 323, 338, 356, 372
];
